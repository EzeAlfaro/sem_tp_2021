...
void *
imprimirAccion (void *data, char *accionIn)
{
  struct parametro *mydata = data;
  //calculo la longitud del array de pasos 
  int sizeArray =
    (int) (sizeof (mydata->pasos_param) / sizeof (mydata->pasos_param[0]));
  ...
  for (i = 0; i < sizeArray; i++)
      ...
      if (strcmp (mydata->pasos_param[i].accion, accionIn) == 0)
	{
	  ...
	  int sizeArrayIngredientes =
	    (int) (sizeof (mydata->pasos_param[i].ingredientes) /
		   sizeof (mydata->pasos_param[i].ingredientes[0]));
...
/*
	//seteo las acciones y los ingredientes (Faltan acciones e ingredientes) B?Se ve hardcodeado no? B?Les parece bien?
...
//Para compilar:   gcc main.c -o ejecutable -lpthread
